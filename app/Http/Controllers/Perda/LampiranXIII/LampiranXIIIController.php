...
namespace App\Http\Controllers\Perda\LampiranXIII;
...
class LampiranXIIIController extends Controller
{
    /**
    ...
    public function index()
    {
        ...
        return view('perda.lampiran_XIII.index')->with($data);
    }
    ...
    public function show(Request $request)
    {
        ...
        $view = view('perda.lampiran_XIII.print', array(
