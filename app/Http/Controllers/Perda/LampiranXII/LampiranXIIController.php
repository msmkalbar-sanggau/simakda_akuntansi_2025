...
namespace App\Http\Controllers\Perda\LampiranXII;
...
class LampiranXIIController extends Controller
{
    /**
    ...
    public function index()
    {
        ...
        return view('perda.lampiran_XII.index')->with($data);
    }
    ...
    public function show(Request $request)
    {
        ...
        $view = view('perda.lampiran_XII.print', array(
