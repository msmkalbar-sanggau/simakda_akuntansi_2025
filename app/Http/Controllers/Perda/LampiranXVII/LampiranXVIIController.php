...
namespace App\Http\Controllers\Perda\LampiranXVII;
...
class LampiranXVIIController extends Controller
{
    /**
    ...
    public function index()
    {
        ...
        return view('perda.lampiran_XVII.index')->with($data);
    }
    ...
    public function show(Request $request)
    {
        ...
        $view = view('perda.lampiran_XVII.print', array(
