...
namespace App\Http\Controllers\Perda\LampiranI3;
...
class LampiranI3Controller extends Controller
{
    /**
    ...
    public function index()
    {
        ...
        return view('perda.lampiran_I.lampiran_I_3.index')->with($data);
    }
    ...
    public function show(Request $request)
    {
        ...
        $view = view('perda.lampiran_I.lampiran_I_3.print', array(
