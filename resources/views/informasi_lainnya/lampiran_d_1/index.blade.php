...
@section('title', 'Lampiran D.1 | SIMAKDA')
...
<div class="row">
    <div class="col-12">
        <div class="card">
            <div class="card-body">
                <h4 class="header-title">Lampiran D.1</h4>
                <p class="sub-header">
                    Rekapitulasi realisasi belanja daerah untuk keselarasan dan keterpaduan urusan pemerintahan daerah dan fungsi dalam kerangka pengelolaan keuangan negara.
                </p>
...
@section('js')
@include('informasi_lainnya.lampiran_d_1.js.index')
@endsection