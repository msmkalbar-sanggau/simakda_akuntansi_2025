...
@section('title', 'Lampiran D.3 | SIMAKDA')
...
<div class="row">
    <div class="col-12">
        <div class="card">
            <div class="card-body">
                <h4 class="header-title">Lampiran D.3</h4>
                <p class="sub-header">
                    Rekapitulasi realisasi belanja untuk pemenuhan Standar Pelayanan Minimal (SPM).
                </p>
...
@section('js')
@include('informasi_lainnya.lampiran_d_3.js.index')
@endsection