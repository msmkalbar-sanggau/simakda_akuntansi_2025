                        ...
                        <div class="card">
                            ...
                            <div class="card-body">
                                <div class="row">
                                    <div class="col-lg-6">
                                        <div class="mb-2">
                                            <label for="kd_sub_kegiatan_koreksi" class="form-label">Kode Sub Kegiatan</label>
                                            <select class="form-control select2-modal" id="kd_sub_kegiatan_koreksi" name="kd_sub_kegiatan_koreksi" required></select>
                                        </div>
                                    </div>
                                    <div class="col-lg-6">
                                        <div class="mb-2">
                                            <label for="nm_sub_kegiatan_koreksi" class="form-label">Nama Sub Kegiatan</label>
                                            <input type="text" id="nm_sub_kegiatan_koreksi" name="nm_sub_kegiatan_koreksi" class="form-control" readonly>
                                        </div>
                                    </div>
                                </div>
                                <div class="row">
                                    <div class="col-lg-6">
                                        <div class="mb-2">
                                            <label for="kd_rek6_koreksi" class="form-label">Kode Rekening</label>
                                            <select class="form-control select2-modal" id="kd_rek6_koreksi" name="kd_rek6_koreksi" required></select>
                                        </div>
                                    </div>
                                    <div class="col-lg-6">
                                        <div class="mb-2">
                                            <label for="nm_rek6_koreksi" class="form-label">Nama Rekening</label>
                                            <input type="text" id="nm_rek6_koreksi" name="nm_rek6_koreksi" class="form-control" readonly>
                                        </div>
                                    </div>
                                </div>
                                <div class="row">
                                    <div class="col-lg-6">
                                        <div class="mb-2">
                                            ...
                                            <select class="form-control select2-modal" id="kd_sumber_dana" name="kd_sumber_dana" required></select>
                                        </div>
                                    </div>
                                    <div class="col-lg-3">
                                        <div class="mb-2">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-lg-3">
                                        <div class="mb-2">
                                            ...
                                            <input type="text" id="nilai_transaksi" name="nilai_transaksi" class="form-control" readonly>
                                        </div>
                                    </div>
                                </div>
                            </div>
...
@section('js')
    @include('jurnal_koreksi.koreksi_rekening.js.create')
@endsection
