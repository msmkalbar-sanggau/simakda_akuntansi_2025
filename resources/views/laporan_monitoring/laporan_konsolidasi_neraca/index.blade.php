...
@section('title', 'Konsolidasi Neraca | SIMAKDA')
...
@section('content')
    <div class="row">
        <div class="col-12">
            <div class="card">
                <div class="card-body">
                    <h4 class="header-title">Konsolidasi Neraca</h4>
                    <p class="sub-header">
                        Laporan Konsolidasi Neraca.
                    </p>
...
@section('js')
    @include('laporan_monitoring.laporan_konsolidasi_neraca.js.index')
@endsection
