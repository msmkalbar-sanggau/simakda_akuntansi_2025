                        ...
                        <div class="col-lg-6">
                            <div class="mb-3">
                                ...
                                <select class="form-control select2" id="jns_ctk" name="jns_ctk">
                                    <option value=""></option>
                                    <option value="map_lo_permen_77">LO</option>
                                    <option value="map_lo_permen_77_objek">LO Objek</option>
                                </select>
                            </div>
                        </div>
                    </div>
...
@section('js')
    @include('laporan_keuangan.lo.js.index')
@endsection
