<script type="text/javascript">
    $(document).ready(function() {
        ...
        $('.cetak').on('click', function() {
            let url = new URL("{{ route('lra.cetak') }}");
            ...
            if (!label) {
                return alert('Label Belum Dipilih')
            }

            if (!permen) {
                return alert('Permen Belum Dipilih')
            }
            ...
            searchParams.append('permen', permen);
