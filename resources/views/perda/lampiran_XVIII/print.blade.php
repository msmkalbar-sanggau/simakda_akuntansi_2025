...
<body>
    ...
    <div style="text-align: center; font-size:14px;">
        ...
        <h4 style="margin: 2px 0px;">DAFTAR KEWAJIBAN JANGKA PANJANG</h4>
        <h4 style="margin: 2px 0px;">PER 31 DESEMBER {{ tahun_anggaran() }}</h4>
    ...
    <table class="bordered">
        ...
        <tbody>
            ...
            @foreach($data as $key => $value)
                @php
                    $aset_tetap_lalu = $value->kredit_lalu - $value->debet_lalu;
                    $saldo_akhir = $aset_tetap_lalu + $value->kredit - $value->debet;
                    $debet += $value->debet;
            ...
            @endforeach
            @php
                $aset_tetap_s = $kredit_lalu - $debet_lalu;
                $saldo_akhir_s = $aset_tetap_s + $kredit - $debet;
            @endphp
            <tr>
