...
<body>
    @if ($skpd->kd_skpd == '1.01.2.22.0.00.02.0000'){
            <table id="header" style="font-family: Bookman Old Style Roman">
                <tr>
                    ...
                    TENTANG PELAKSANAAN ANGGARAN PENDAPATAN DAN BELANJA DAERAH <br>
    ...
    <div style="text-align: center; font-size:14px;">
        ...
        <h4 style="margin: 2px 0px;">RINCIAN APBD MENURUT URUSAN PEMERINTAHAN DAERAH, ORGANISASI, PROGRAM, KEGIATAN, SUB
            KEGIATAN, KELOMPOK, <br> DAN JENIS PENDAPATAN, BELANJA, DAN PEMBIAYAAN</h4>
    ...
    <table class="bordered">
        <thead align="center">
            <tr>
                <th rowspan="2" colspan="9">Kode</th>
        ...
        <tbody>
            ...
            @foreach ($data as $key => $value)
                ...
                <!-- jumlah pendapatan -->
                @if (in_array(substr($value->kode, 33, 1), ['4']) &&
                        ($key + 1 == count($data) || ($key + 1 < count($data) && substr($data[$key + 1]->kode, 33, 1) > '4')))
                    <tr>
                        <td></td>
                        <td></td>
                        <td></td>
                ...
                <!-- jumlah belanja -->
                @if (in_array(substr($value->kode, 33, 1), ['5']) &&
                        ($key + 1 == count($data) || ($key + 1 < count($data) && substr($data[$key + 1]->kode, 33, 1) > '5')))
                    <tr>
                        <td></td>
                        <td></td>
                        <td></td>
                ...
                @if (in_array(substr($value->kode, 33, 2), ['61']) &&
                        ($key + 1 == count($data) || ($key + 1 < count($data) && substr($data[$key + 1]->kode, 33, 2) > '61')))
                    <tr>
                        <td></td>
                        <td></td>
                        <td></td>
                        ...
                        <td>{{ $bertambah_berkurang_penp >= 0 ? rupiah($bertambah_berkurang_penp) : '(' . rupiah(abs($bertambah_berkurang_penp)) . ')' }}
                        </td>
                        <td>{{ $penerimaan_pembiayaan_ang == 0 ? rupiah(0) : rupiah(($penerimaan_pembiayaan_real * 100) / $penerimaan_pembiayaan_ang) }}
                        </td>
                        <td></td>
                    </tr>
                @endif
                ...
                @if (in_array(substr($value->kode, 33, 2), ['62']) &&
                        ($key + 1 == count($data) || ($key + 1 < count($data) && substr($data[$key + 1]->kode, 33, 2) > '62')))
                    <tr>
                        <td></td>
                        <td></td>
                        <td></td>
                        ...
                        <td>{{ $bertambah_berkurang_pengp >= 0 ? rupiah($bertambah_berkurang_pengp) : '(' . rupiah(abs($bertambah_berkurang_pengp)) . ')' }}
                        </td>
                        <td>{{ $pengeluaran_pembiayaan_ang == 0 ? rupiah(0) : rupiah(($pengeluaran_pembiayaan_real * 100) / $pengeluaran_pembiayaan_ang) }}
                        </td>
                        <td></td>
                    </tr>
                @endif
                ...
                <!-- tabel kosong -->
                @if (strlen($value->kode) == 34 ||
                        (strlen($value->kode) == 37 &&
                            ($key + 1 == count($data) || ($key + 1 < count($data) && strlen($data[$key + 1]->kode) != 37))))
                    <tr>
                        <td>&nbsp;</td>
                        <td></td>
                        <td></td>
                ...
                <!-- surplus defisit -->
                @if (in_array(substr($value->kode, 33, 1), ['4', '5']) &&
                        ($key + 1 == count($data) || ($key + 1 < count($data) && substr($data[$key + 1]->kode, 33, 1) == '6')))
                    @php
                    ...
                    <tr>
                        ...
                        <td>{{ $surplus_real >= 0 ? rupiah($surplus_real) : '(' . rupiah(abs($surplus_real)) . ')' }}
                        </td>
                        <td>{{ $bertambah_berkurang_surplus >= 0 ? rupiah($bertambah_berkurang_surplus) : '(' . rupiah(abs($bertambah_berkurang_surplus)) . ')' }}
                        </td>
                ...
                @if (substr($value->kode, 33, 1) == '6' && $key + 1 == count($data))
                    ...
                    <tr>
                        ...
                        <td>{{ $bertambah_berkurang_netto >= 0 ? rupiah($bertambah_berkurang_netto) : '(' . rupiah(abs($bertambah_berkurang_netto)) . ')' }}
                        </td>
            ...
            <tr>
                ...
                <td>{{ $bertambah_berkurang_silpa >= 0 ? rupiah($bertambah_berkurang_silpa) : '(' . rupiah(abs($bertambah_berkurang_silpa)) . ')' }}
                </td>
    ...
    @if ($skpd->kd_skpd == '2.09.3.27.0.00.01.0000' || $skpd->kd_skpd == '2.19.3.26.0.00.01.0000')
